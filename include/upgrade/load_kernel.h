...
struct mtd_device {
	...
	unsigned short num_parts;			/* number of partitions on this device */
...
struct part_info {
	...
	unsigned char auto_name;			/* set to 1 for generated name */
	unsigned int size;			/* total size of the partition */
	unsigned int offset;			/* offset within device */
	void *jffs2_priv;		/* used internaly by jffs2 */
	unsigned int mask_flags;			/* kernel MTD mask flags */
...
struct mtdids {
	...
	unsigned char num;				/* device number */
