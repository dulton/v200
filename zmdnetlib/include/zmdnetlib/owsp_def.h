...
typedef struct _VersionResponse
{
	TLV_HEADER				HEADER;
	TLV_V_VersionInfoRequest	Version;
}VersionResponse;

typedef struct _LoginResponse
{
	TLV_HEADER				HEADER;
	TLV_V_LoginResponse		Login;
}LoginResponse;

typedef struct _LoginFaileResponse
{
...
typedef struct _DVSInfoRequest
{
	TLV_HEADER				HEADER;
	TLV_V_DVSInfoRequest		info;
}DVSInfoRequest;

typedef struct _ChannelResponse
{
	TLV_HEADER				HEADER;
	TLV_V_ChannelResponse	Channel;
}ChannelResponse;

typedef struct _StreamDataFormat
{
	TLV_HEADER				HEADER;
	TLV_V_StreamDataFormat	DataFormat;
}StreamDataFormat;

typedef struct _VideoFrameInfo
{
	TLV_HEADER				HEADER;
	TLV_V_VideoFrameInfo	VideoInfo;
}VideoFrameInfo;
...
typedef struct _LoginSuessResponse
{
	OwspPacketHeader			PacketHeader;
	VersionResponse				VersionRes;
	DVSInfoRequest				DVSInfo;
...
typedef struct _ChanageChannelResponse
{
	OwspPacketHeader			PacketHeader;
	ChannelResponse				ChannelRes;
	StreamDataFormat			Format;
	//cancel by table
	//VideoFrameInfo			FrameInfo;
}ChanageChannelResponse;
typedef struct _PtzResponse
{
	TLV_HEADER				HEADER;
	TLV_V_ControlResponse	ControlResponse;
}PtzResponse;
typedef struct _PtzCtrResponse
{
	OwspPacketHeader			PacketHeader;
	PtzResponse				ptz;
}PtzCtrResponse;
...
int Mobile_Main(int TcpListenPort,int UdpListenPort,int ListenNum);
//#pragma pack(pop)
